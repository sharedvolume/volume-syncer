...
# Add metadata labels
LABEL maintainer="SharedVolume Team"
LABEL org.opencontainers.image.title="Volume Syncer"
LABEL org.opencontainers.image.description="Enterprise-grade Kubernetes SharedVolume operator synchronization service with support for SSH, Git, HTTP, and S3 sources"
